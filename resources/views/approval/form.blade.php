...
@section('content')
	<form class="form-horizontal" method="post">
	  ...
	  <div class="form-group form-group-sm">
	    ...
	    <div class="col-md-9">
	      <textarea name="Alamat" class="form-control" id="Alamat" placeholder="Alamat" readonly>{{ $data->Alamat or '' }}</textarea>
	    </div>
	  </div>
	  <div class="form-group form-group-sm">
	    <label for="Jenis_Project" class="col-md-3 control-label">Jenis Project</label>
	    <div class="col-md-9">
	      <input type="text" name="Jenis_Project" class="form-control" id="Jenis_Project" placeholder="Jenis Project" value="{{ $data->Jenis_Project or '' }}" readonly>
	    </div>
	  </div>
	  <div class="form-group form-group-sm">
	  ...
	  <div class="form-group form-group-sm">
	    ...
	    <div class="col-md-9">
	      <input type="text" name="Tanggal_Input" class="form-control" id="Tanggal_Input" placeholder="Tanggal Input" value="{{ $data->Tanggal_Input or '' }}" readonly>
	    </div>
	  </div>
	  <div class="form-group form-group-sm hidden">
	    <label for="File_Name" class="col-md-3 control-label">File Survey</label>
	    <div class="col-md-9">
	      No File Uploaded
	    </div>
	  </div>
